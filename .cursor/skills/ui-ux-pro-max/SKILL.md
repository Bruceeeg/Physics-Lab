...
For the full 10-category rule list, read `references/quick-reference.md`. For app-specific polish and the canonical pre-delivery checklist, read `references/pro-rules.md`.
